...
const ALIASES_TO_CANONICAL: readonly { aliases: readonly string[]; key: string }[] = [
  ...
  { aliases: ["pt141", "pt-141", "pt 141", "bremelanotide"], key: "pt-141" },
  ...
  { aliases: ["ll37", "ll-37", "ll 37"], key: "ll-37" },
  ...
  { aliases: ["cjc no dac", "cjc no dac 5mg", "cjc-1295 no dac", "cjc 1295 no dac"], key: "cjc-1295 no dac" },
  { aliases: ["cjc dac", "cjc dac", "cjc+ dac", "cjc-1295 dac", "cjc 1295 dac"], key: "cjc-1295 dac" },
  { aliases: ["aod", "aod-9604", "aod 9604"], key: "aod-9604" },
